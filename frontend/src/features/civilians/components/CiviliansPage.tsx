...
import { useCivilians, useCreateCivilian, useUpdateCivilian } from '../hooks/useCivilians'
import { CivilianFormModal } from './CivilianFormModal'
...
export function CiviliansPage() {
  const { data: pensioners = [], isLoading } = useCivilians()
  const createMutation = useCreateCivilian()
  const updateMutation = useUpdateCivilian()
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      <PageHeader
        title="Pensionistas"
        description="Gestión de pensionistas civiles y policiales"
        actions={
          <button
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <span style={{ fontSize: '10px', fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#94A3B8' }}>Civiles</span>
                ...
                >
                  ...
                  <td style={{ padding: '12px 20px' }}>
                    ...
                    >
                      ...
                      {p.pensioner_type === 'police' ? 'Policía' : 'Civil'}
                    </span>
                  </td>
