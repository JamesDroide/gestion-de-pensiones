...
// Mantener compatibilidad con consumo (que aún usa estos tipos internamente)
export type Civilian = Pensionista
export type CreateCivilianInput = CreatePensionerInput
